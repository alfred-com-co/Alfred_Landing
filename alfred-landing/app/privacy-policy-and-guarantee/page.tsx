...
export const metadata: Metadata = {
  title: 'Términos y Condiciones y Aviso de Privacidad | Alfred',
  description: 'Términos y Condiciones de uso de la aplicación móvil de Alfred y del sitio web, junto con el Aviso de Privacidad.',
};

export default function PrivacyPolicyAndGuaranteePage() {
  return (
      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-400">
            Términos y Condiciones de uso de la aplicación móvil de Alfred y del sitio web <a href="http://www.alfred.com.co" className="text-[#00E5FF] hover:underline">www.alfred.com.co</a>
          </p>
        </div>

        <section className="space-y-6">
          <p>
            El sitio web o aplicación que está visitando es propiedad de la sociedad Alfred S.A.S. (“ALFRED”), identificada con el Nit 901.401.410-8, domiciliada en la Calle 93 A # 11 – 36 Oficina 203 de la ciudad de Bogotá, Colombia.
          </p>

          <h2 className="text-2xl font-bold text-white font-gotham mt-10">Artículo I. Cláusula general de uso</h2>
          <p>
            Al ingresar, consultar y hacer uso de las funcionalidades de www.alfred.com.co, y/o a la aplicación móvil de ALFRED (en adelante y de forma genérica la “Plataforma”), el Usuario (en adelante, “El Usuario”) se compromete a leer, informarse y cumplir los términos y condiciones de uso acá establecidos, así como la Política de Tratamiento de Datos Personales que encuentra en el siguiente link <a href="https://alfred.com.co/privacy-policy-and-guarantee" className="text-[#00E5FF] hover:underline break-words">https://alfred.com.co/privacy-policy-and-guarantee</a>, los cuales podrán ser modificados unilateralmente por ALFRED, de tiempo en tiempo y sin previo aviso.
          </p>
          <p>
            En cualquier caso, las modificaciones que ALFRED le haga a estos términos y condiciones, así como a la Política de Tratamiento de Datos Personales, serán publicados en la página Web de ALFRED y le serán informadas de manera oportuna para que El Usuario las conozca y decida si las acepta nuevamente.
          </p>
          <p>
            Con la aceptación de los presentes términos y condiciones, el Usuario acepta que la prestación de los servicios será realizada por parte de terceros aliados de ALFRED (en adelante los “Aliados”) y que por lo tanto, ALFRED es una Plataforma tecnológica que pone en contacto a Usuarios y Aliados que les permite acceder a servicios relacionados con el cuidado, mantenimiento y reparación de vehículos automotores. En todo caso, la solicitud de servicios a través de la Plataforma, sujetará a los presentes términos y condiciones. Si El Usuario está en desacuerdo con estos Términos y Condiciones, los cuales tienen un carácter obligatorio y vinculante, y decide no acatarlos, no podrá utilizar el sitio web, la aplicación móvil, ni acceder a los servicios ofrecidos a través de la Plataforma.
          </p>
          <p>
            <strong>Canales Autorizados:</strong> WhatsApp (+57 323 254 0101) correo electrónico <a href="mailto:soporte@alfred.co" className="text-[#00E5FF] hover:underline">soporte@alfred.co</a>
          </p>
          <p>
            <strong>Parágrafo.</strong> El Usuario declara y manifiesta que es consciente que los servicios ofrecidos por la Plataforma de ALFRED son prestados por terceros Aliados, previamente validados y examinados por ALFRED. Por lo tanto, ALFRED no es responsable por el trato o profesionalismo de los Aliados, salvo que afecten la calidad de los servicios prestados. El Usuario podrá, y así lo exhorta ALFRED, enviar comentarios a través de los Canales autorizados relativos a la cordialidad, buen trato y profesionalismo de los Aliados para efectos de que ALFRED pueda tomar las medidas o correctivos necesarios.
          </p>

          <h2 className="text-2xl font-bold text-white font-gotham mt-10">Artículo II. Uso de la Plataforma</h2>
          
          <h3 className="text-xl font-semibold text-white mt-6">Sección 2.01 – Registro y uso del sitio</h3>
          <p>
          ...
          <p>
            (b) Al finalizar el diligenciamiento de la información en la Plataforma y aceptar a través de la misma la creación del usuario, El Usuario está confirmando su conocimiento y aceptación de los términos y condiciones descritos en el presente documento.
          </p>
          <p>
            (c) Para pagos con tarjeta de crédito, con el fin de confirmar la veracidad de la información financiera registrada, ALFRED realizará una transacción de verificación por [COP $100]. El Usuario acepta y se obliga a mantener actualizada la información financiera de la cuenta o tarjetas de crédito registrada para el pago de los servicios. ALFRED se reserva el derecho de monitorear y grabar, haciendo uso de cualquier tecnología disponible o por conocerse, toda la actividad que se dé dentro de su Plataforma sin captar, para este tema en particular, ningún Dato Personal. Lo anterior, se hace (i) para analizar las métricas y estadísticas del sitio, (ii) no permite identificar a ningún Usuario, (iii) no le suministra datos personales de ningún tipo a ALFRED y (iv) no se deriva en un tratamiento de los datos personales de los usuarios.
          </p>
          <p>
            Para efectos de lo anterior, el monitoreo y grabación de la actividad al que alude este literal puede recaer, entre otros, sobre la identificación de la URL de la que provienen (estén o no en nuestro sitio web), a qué URL acceden seguidamente (estén o no en nuestro sitio web), qué navegador están usando, y sus direcciones IP. También las páginas visitadas, las búsquedas realizadas, las publicaciones, compras o ventas, calificaciones y réplicas ingresadas, mensajes, etc.
          </p>
          <p>
            (d) ALFRED podrá utilizar diversos medios para verificar la identidad de sus usuarios, pero no será responsable en ningún caso, ni ante tercero alguno, de la veracidad de los datos personales que le sean suministrados.
          </p>

          <h3 className="text-xl font-semibold text-white mt-6">Sección 2.02 – Clave secreta</h3>
          <p>
            Los usuarios registrados tendrán un Nombre de Usuario y una Contraseña que les permitirá el acceso personalizado, confidencial y seguro a la Plataforma. Estos datos configurados por el Usuario serán para su uso exclusivo y, en consecuencia, será responsabilidad del Usuario observar el mayor cuidado y diligencia respecto de las medidas de seguridad que resulten razonables para este tipo de información. El Nombre de Usuario y la Contraseña son de uso personal e intransferible. Su entrega a terceras personas o su utilización por dichas terceras personas, no implicará responsabilidad alguna para ALFRED.
          </p>
          ...
          <p>El Usuario se compromete a notificarle a ALFRED, en forma inmediata a la dirección de correo <a href="mailto:info@alfred.com.co" className="text-[#00E5FF] hover:underline">info@alfred.com.co</a>, cualquier uso no autorizado de su cuenta, así como el ingreso realizado por terceros no autorizados a la misma.</p>
          <p>El Usuario no podrá vender, ceder o transferir su cuenta.</p>

          <h3 className="text-xl font-semibold text-white mt-6">Sección 2.03 – Procedimiento para solicitudes de servicios</h3>
          <p>Para realizar solicitudes de servicio, el Usuario ingresará a la Plataforma con su usuario y clave secreta.</p>
          <p>
            El Usuario seleccionará el servicio que desea le sea prestado por el Aliado, diligencia la información específica que, de acuerdo con el tipo de Servicio, sea solicitada por el sistema; información sin la cual no será posible la creación de la solicitud de servicio. Finalizado el diligenciamiento de los formularios de información requeridos por la Plataforma, el Usuario seleccionará la opción “Solicitar Servicio”. Con la solicitud del servicio, el Usuario está aceptando los presentes términos y condiciones, así como los términos de la prestación del servicio específico que se indiquen en la Plataforma.
          </p>
          <p>Una vez el Usuario realice la solicitud del servicio, la Plataforma automáticamente enviará una notificación al Aliado para que este confirme el servicio y reserve el turno para la prestación del mismo. Se deja constancia que el Aliado tiene el compromiso con ALFRED de reservar el turno y prestarlos servicios en el horario indicado por la Plataforma, sin embargo, ALFRED no podrá garantizar que el servicio se preste en el horario reservado ya que esto es potestad única y exclusiva del Aliado.</p>
          ...
          <h3 className="text-xl font-semibold text-white mt-6">Sección 2.04 – Condiciones para movilizar el vehículo</h3>
          ...
          <ul className="list-disc pl-6 space-y-1">
            <li>Que el vehículo se movilice por sus propios medios, en caso contrario, se notificará al Usuario para confirmar si requiere apoyo de Alfred en la consecución de una grúa que permita su movilización.</li>
          ...
          <h3 className="text-xl font-semibold text-white mt-6">Sección 2.05 – Tarifas</h3>
          ...
          <ol className="list-decimal pl-6 space-y-1">
            <li><strong>Adquisición de servicios:</strong> El Usuario podrá utilizar el saldo a favor cualquier tipo de servicio que seleccione dentro de la Plataforma. El saldo a favor se descontará automáticamente al valor total del servicio.</li>
            <li><strong>Reintegro del saldo:</strong> El Usuario podrá solicitar la devolución del saldo a favor, aportando la certificación bancaria. El ajuste se verá reflejado dentro de los treinta (30) días hábiles siguientes a la solicitud radicada por el usuario.</li>
            <li><strong>Caducidad del saldo:</strong> Transcurridos los cuatro (4) meses de la fecha del pago sin que el Usuario haya utilizado el saldo a favor, este quedará automáticamente caducado y no podrá ser reclamado, transferido ni reembolsado bajo ninguna circunstancia.</li>
          </ol>

          <h3 className="text-xl font-semibold text-white mt-6">Sección 2.07 – Multas de tránsito</h3>
          ...
          <h3 className="text-xl font-semibold text-white mt-6">Sección 2.08 – Cancelación del Servicio</h3>
          ...
          <h3 className="text-xl font-semibold text-white mt-6">Sección 2.09 – Finalización de los servicios</h3>
          ...
          <p><strong>1) Garantías en los términos para la prestación del servicio</strong></p>
          ...
          <p><strong>2) Garantía de calidad del servicio</strong></p>
          ...
          <ol className="list-[lower-alpha] pl-6 space-y-1">
           ...
           <h3 className="text-xl font-semibold text-white mt-6">Sección 2.11 – Exclusiones y/o restricciones de las Garantías y reclamaciones</h3>
           <ol className="list-[lower-alpha] pl-6 space-y-1">
             <li>El deterioro y /o desgaste normal, resultado de la utilización del vehículo.</li>
             <li>Se haya efectuado en el vehículo intervenciones adicionales por cuenta propia del usuario, sin completar el debido proceso de garantías y sin previa autorización por parte de Alfred por cualquier de los canales autorizados, que afecten directa o indirectamente el desempeño de los trabajos y/o servicios y/trabajos que el usuario contrato con Alfred.</li>
           ...
           <h2 className="text-2xl font-bold text-white font-gotham mt-10">Artículo III. Alcance de la prestación de servicios específicos</h2>
           
           <h3 className="text-xl font-semibold text-white mt-6">Sección 3.01 – Servicio de lavado</h3>
           ...
           <p>En los casos en que el servicio de lavado sea prestado sin acompañamiento del conductor o representante del cliente, se entenderá que al momento de la entrega y retiro del vehículo por parte del cliente en las instalaciones del lavadero, este acepta el estado del servicio a conformidad, eximiendo expresamente a Alfred SAS de cualquier responsabilidad posterior relacionada con inconformidades, reclamos o solicitudes de garantía sobre dicho servicio. Alfred SAS actúa como intermediario en la gestión del servicio, pero no asume responsabilidad por posibles daños, defectos o insatisfacción que no hayan sido reportados al momento de la entrega en sitio. Es responsabilidad del cliente verificar el estado del vehículo al momento de recibirlo.</p>
           <p>Sin perjuicio de lo anterior, para los servicios de lavado prestados sin acompañamiento del conductor o representante del cliente, aplicarán adicionalmente las siguientes condiciones:</p>
           <p><strong>a) Objetos personales:</strong> ALFRED SAS y los Aliados no se hacen responsables por la pérdida, daño o hurto de objetos personales que no hayan sido debidamente relacionados o declarados al momento de la recepción del vehículo en el lavadero. Es responsabilidad del cliente retirar previamente cualquier objeto de valor antes de la prestación del servicio.</p>
           <p><strong>b) Golpes, rayones y estado del vehículo:</strong> El cliente deberá verificar el estado general del vehículo al momento de su retiro. Una vez el vehículo salga de las instalaciones del lavadero, no se aceptarán reclamaciones relacionadas con golpes, rayones, daños estéticos o similares, independientemente de su causa.</p>
           <p><strong>c) Plazos para la presentación de reclamaciones:</strong> Cualquier reclamación formal relacionada con el servicio de lavado deberá ser presentada el mismo día de la prestación del servicio o, a más tardar, dentro de los dos (2) días calendario siguientes. Vencido este plazo, la reclamación no será aceptada ni gestionada por ALFRED SAS ni por el Aliado.</p>
           <p><strong>d) Grabaciones de seguridad:</strong> La disponibilidad de grabaciones de seguridad dependerá de las políticas internas de cada Aliado. Algunos establecimientos conservan dichas grabaciones por períodos limitados (por ejemplo, hasta tres (3) o cuatro (4) días calendario), mientras que en otros casos la disponibilidad estará sujeta a sus circuitos internos de seguridad y validación propia. ALFRED SAS no garantiza la disponibilidad de grabaciones fuera de dichos plazos.</p>
           <p><strong>e) Gestión y vigencia de cortesías:</strong> En caso de otorgarse una cortesía como parte de la gestión de una novedad, esta deberá ser redimida dentro de un plazo máximo de diez (10) días calendario contados a partir del suceso que dio origen a la misma. Vencido este término, la cortesía perderá automáticamente su validez, conforme a las condiciones definidas por el Aliado.</p>

           <h2 className="text-2xl font-bold text-white font-gotham mt-10">Artículo IV. Información del usuario</h2>
           ...
           <p>La información que ALFRED obtenga de estas entidades será tratada en forma confidencial y de acuerdo con (i) estos términos y condiciones y (ii) con la Política de Tratamiento de Datos Personales que puede consultar en el siguiente link <a href="https://alfred.com.co/privacy-policy-and-guarantee" className="text-[#00E5FF] hover:underline">https://alfred.com.co/privacy-policy-and-guarantee</a></p>
           ...
           <h2 className="text-2xl font-bold text-white font-gotham mt-10">Artículo V. Autorización del usuario</h2>
           ...
           <h2 className="text-2xl font-bold text-white font-gotham mt-10">Artículo VIII. Confidencialidad de la información</h2>
           ...
           <h2 className="text-2xl font-bold text-white font-gotham mt-10">Artículo IX. Aviso de Privacidad</h2>
           ...
           <h2 className="text-2xl font-bold text-white font-gotham mt-10">Artículo X. Fallas en el sistema</h2>
           ...
           <h2 className="text-2xl font-bold text-white font-gotham mt-10">Artículo XV. Almacenamiento de la información</h2>
           ...
           <h2 className="text-2xl font-bold text-white font-gotham mt-10">Artículo XVI. Indemnidad</h2>
           ...
           <h2 className="text-2xl font-bold text-white font-gotham mt-10">Artículo XVII. Jurisdicción y Ley Aplicable</h2>
           <p>Estos términos y condiciones están regidos, en todos sus puntos, por las leyes vigentes en la República de Colombia.</p>
        </section>

        {/* AVISO DE PRIVACIDAD */}
        <div className="pt-16 pb-8 border-t border-gray-700/50">
          <h1 className="text-4xl lg:text-5xl font-bold text-white font-gotham mb-10 text-center">
            Aviso de Privacidad
          </h1>
        </div>
        ...
        <section className="space-y-6">
          <p>
            El presente Aviso de Privacidad (en adelante el “Aviso”) establece los términos y condiciones en virtud de los cuales ALFRED SAS, sociedad legalmente constituida según las leyes de la República de Colombia, con domicilio en Carrera 14 # 86a-15, piso 5, realizará el tratamiento de sus datos personales.
          </p>

          <h2 className="text-2xl font-bold text-white font-gotham mt-10">CAPÍTULO 1 – TRATAMIENTO Y FINALIDAD</h2>
          <ol className="list-decimal pl-6 space-y-4">
            <li>
              <strong>RECOLECCIÓN.</strong> ALFRED SAS recolecta información personal de sus clientes, proveedores y trabajadores con ocasión del giro ordinario de sus negocios. Dicha información es recolectada por diferentes medios, ya sean físicos o electrónicos, y comprende en general, pero sin limitarse: nombres, teléfonos, números de identificación, correos electrónicos, dirección de residencia y otros datos de contacto que resulten necesarios para la prestación de servicios que ofrece ALFRED SAS.
            </li>
            <li>
              <p><strong>TRATAMIENTO.</strong> La información que consta en las bases de datos de ALFRED SAS es sometida a distintas formas de tratamiento, como recolección, intercambio, actualización procesamiento, reproducción, compilación, almacenamiento, uso, sistematización y organización, todos ellos de forma parcial o total en cumplimiento de las finalidades autorizadas por el titular de la información.</p>
              <p>La información personal recolectada por ALFRED SAS no podrá ser utilizada para una finalidad distinta a la prevista en política de tratamiento de datos personales, en la Ley o en la autorización entregada por el titular.</p>
              <p>En el evento que se llegare a recolectar datos sensibles, los mismos serán tratados estrictamente con las finalidades autorizadas por el titular y este tendrá el derecho de decidir si brinda o no tal información. Asimismo, la recolección de estos datos se hará en cumplimiento de las disposiciones al respecto de la Ley 1581 de 2012 y el Decreto 1377 de 2013.</p>
            </li>
            <li>
              <p><strong>FINALIDAD.</strong> La información recolectada por ALFRED SAS, tiene como finalidad facilitar el desarrollo de su objeto social, así como hacer efectiva la comunicación con los clientes, proveedores y trabajadores relacionada con los servicios, productos, necesidades, alianzas, contenidos y para facilitarle el acceso general a la información de interés.</p>
              <p>Asimismo, ALFRED SAS guarda la información necesaria para dar cumplimiento a deberes legales, principalmente en materia contable, societaria, laboral y tributaria.</p>
            </li>
          </ol>

          <h2 className="text-2xl font-bold text-white font-gotham mt-10">CAPÍTULO 2 – DERECHOS DE LOS TITULARES</h2>
          <p>Los titulares de la información o datos personales tendrán los siguientes derechos:</p>
          <ol className="list-[lower-alpha] pl-6 space-y-1">
            <li>Conocer, actualizar y rectificar sus datos personales frente a ALFRED SAS. Este derecho se podrá ejercer, entre otros frente a datos parciales, inexactos, incompletos, fraccionados, que induzcan a error, o aquellos cuyo Tratamiento esté expresamente prohibido o no haya sido autorizado;</li>
            <li>Solicitar prueba de la autorización de tratamiento de datos personales otorgada a ALFRED SAS.</li>
            <li>Ser informado por ALFRED SAS del Tratamiento o el Encargado del Tratamiento, previa solicitud, respecto del uso que les ha dado a sus datos personales.</li>
            <li>Presentar ante la Superintendencia de Industria y Comercio quejas por infracciones a lo dispuesto en la normatividad vigente en materia de tratamiento de datos personales.</li>
            <li>Revocar la autorización y/o solicitar la supresión del dato cuando en el Tratamiento no se respeten los principios, derechos y garantías constitucionales y legales. La revocatoria y/o supresión procederá cuando la Superintendencia de Industria y Comercio haya determinado que en el Tratamiento ALFRED SAS han incurrido en conductas contrarias a esta ley y a la Constitución;</li>
          ...
          <h2 className="text-2xl font-bold text-white font-gotham mt-10">CAPÍTULO 3 – MECANISMOS PARA CONOCER LA POLÍTICA DE TRATAMIENTO</h2>
          <p>
            El Titular puede acceder a nuestra Política de Tratamiento de información, la cual se encuentra publicada en medio electrónico en la página web: <a href="http://www.alfred.co" className="text-[#00E5FF] hover:underline">www.alfred.co</a>
          </p>
